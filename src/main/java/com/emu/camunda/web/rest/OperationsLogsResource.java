...
/**
 * REST controller for managing {@link com.emu.camunda.domain.OperationsLogs}.
 */
@RestController
@RequestMapping("/api")
public class OperationsLogsResource {
    ...
    private static final String ENTITY_NAME = "camundaServerOperationsLogs";
    ...
    public ResponseEntity<OperationsLogsDTO> updateOperationsLogs(@RequestBody OperationsLogsDTO operationsLogsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, operationsLogsDTO.getId().toString()))
            .body(result);
    }
