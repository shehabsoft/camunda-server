...
import com.emu.camunda.service.ExceptionLogsService;
...
/**
 * REST controller for managing {@link com.emu.camunda.domain.ExceptionLogs}.
 */
@RestController
@RequestMapping("/api")
public class ExceptionLogsResource {
    ...
    private static final String ENTITY_NAME = "camundaServerExceptionLogs";
    ...
    public ResponseEntity<ExceptionLogsDTO> updateExceptionLogs(@RequestBody ExceptionLogsDTO exceptionLogsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, exceptionLogsDTO.getId().toString()))
            .body(result);
    }
